...
The Database component is a full database toolkit for PHP, providing an expressive query builder. It currently supports MySQL, Postgres, SQL Server, and SQLite.
